...
namespace Ideal.Core.Orm.Domain
{
        ...
        where TAggregateRoot : class, IAggregateRoot<TKey>
    {
        ...
        Task<int> UpdateColumnsAsync(Expression<Func<TAggregateRoot, bool>> predicate);
        ...
        Task<int> UpdateColumnsAsync(Expression<Func<TAggregateRoot, bool>> columnPredicate, Expression<Func<TAggregateRoot, bool>> wherePredicate);

        /// <summary>
        /// 批量更新实体列
        /// </summary>
        /// <param name="predicate">实体谓词</param>
        Task<int> UpdateColumnsAsync(Expression<Func<TAggregateRoot, TAggregateRoot>> predicate);
        ...
        /// <param name="wherePredicate">条件谓词</param>
        Task<int> UpdateColumnsAsync(Expression<Func<TAggregateRoot, TAggregateRoot>> columnPredicate, Expression<Func<TAggregateRoot, bool>> wherePredicate);
