...
namespace Ideal.Core.Redis
{
    ...
    public interface IRedisService
    {
        ...
        /// <returns></returns>
        Task<long> ZInterStoreAsync(string destination, decimal[] weights, RedisAggregate aggregate, params string[] keys);
        ...
        /// <param name="stop">结束位置，0表示第一个元素，-1表示最后一个元素</param>
        /// <returns></returns>
        Task<(string member, decimal score)[]> ZRangeWithScoresAsync(string key, long start, long stop);
        ...
        /// <param name="stop">结束位置，0表示第一个元素，-1表示最后一个元素</param>
        /// <returns></returns>
        Task<(T member, decimal score)[]> ZRangeWithScoresAsync<T>(string key, long start, long stop);
        ...
        /// <returns></returns>
        Task<string[]> ZRangeByScoreAsync(string key, decimal min, decimal max, long? limit = null, long offset = 0);
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        Task<T[]> ZRangeByScoreAsync<T>(string key, decimal min, decimal max, long? limit = null, long offset = 0);
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        Task<string[]> ZRangeByScoreAsync(string key, string min, string max, long? limit = null, long offset = 0);
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        Task<T[]> ZRangeByScoreAsync<T>(string key, string min, string max, long? limit = null, long offset = 0);
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        Task<(string member, decimal score)[]> ZRangeByScoreWithScoresAsync(string key, decimal min, decimal max, long? limit = null, long offset = 0);
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        Task<(T member, decimal score)[]> ZRangeByScoreWithScoresAsync<T>(string key, decimal min, decimal max, long? limit = null, long offset = 0);
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        Task<(string member, decimal score)[]> ZRangeByScoreWithScoresAsync(string key, string min, string max, long? limit = null, long offset = 0);
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        Task<(T member, decimal score)[]> ZRangeByScoreWithScoresAsync<T>(string key, string min, string max, long? limit = null, long offset = 0);
        ...
        /// <param name="stop">结束位置，0表示第一个元素，-1表示最后一个元素</param>
        /// <returns></returns>
        Task<(string member, decimal score)[]> ZRevRangeWithScoresAsync(string key, long start, long stop);
        ...
        /// <param name="stop">结束位置，0表示第一个元素，-1表示最后一个元素</param>
        /// <returns></returns>
        Task<(T member, decimal score)[]> ZRevRangeWithScoresAsync<T>(string key, long start, long stop);
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        Task<string[]> ZRevRangeByScoreAsync(string key, decimal max, decimal min, long? limit = null, long? offset = 0);
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        Task<T[]> ZRevRangeByScoreAsync<T>(string key, decimal max, decimal min, long? limit = null, long offset = 0);
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        Task<string[]> ZRevRangeByScoreAsync(string key, string max, string min, long? limit = null, long? offset = 0);
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        Task<T[]> ZRevRangeByScoreAsync<T>(string key, string max, string min, long? limit = null, long offset = 0);
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        Task<(string member, decimal score)[]> ZRevRangeByScoreWithScoresAsync(string key, decimal max, decimal min, long? limit = null, long offset = 0);
        /// <summary>
        /// 返回有序集中指定分数区间内的成员和分数，分数从高到低排序
        /// </summary>
        /// <typeparam name="T">byte[] 或其他类型</typeparam>
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        Task<(T member, decimal score)[]> ZRevRangeByScoreWithScoresAsync<T>(string key, decimal max, decimal min, long? limit = null, long offset = 0);
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        Task<(string member, decimal score)[]> ZRevRangeByScoreWithScoresAsync(string key, string max, string min, long? limit = null, long offset = 0);
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        Task<(T member, decimal score)[]> ZRevRangeByScoreWithScoresAsync<T>(string key, string max, string min, long? limit = null, long offset = 0);
        ...
        /// <param name="keys">一个或多个有序集合，不含prefix前辍</param>
        /// <returns></returns>
        Task<long> ZUnionStoreAsync(string destination, decimal[] weights, RedisAggregate aggregate, params string[] keys);
        ...
        /// <returns></returns>
        Task<RedisScan<(string member, decimal score)>> ZScanAsync(string key, long cursor, string pattern = null, long? count = null);
        ...
        /// <param name="count">数量</param>
        /// <returns></returns>
        Task<RedisScan<(T member, decimal score)>> ZScanAsync<T>(string key, long cursor, string pattern = null, long? count = null);
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        Task<string[]> ZRangeByLexAsync(string key, string min, string max, long? limit = null, long offset = 0);
        ...
        /// <param name="offset">返回条件偏移位置</param>
        /// <returns></returns>
        Task<T[]> ZRangeByLexAsync<T>(string key, string min, string max, long? limit = null, long offset = 0);
        ...
        /// <param name="value">增量值(默认=1)</param>
        /// <returns></returns>
        Task<decimal> HIncrByFloatAsync(string key, string field, decimal value = 1);
        ...
        /// <param name="count">数量</param>
        /// <returns></returns>
        Task<(string member, decimal score)[]> ZPopMaxAsync(string key, long count);
        ...
        /// <param name="count">数量</param>
        /// <returns></returns>
        Task<(T member, decimal score)[]> ZPopMaxAsync<T>(string key, long count);
        ...
        /// <param name="count">数量</param>
        /// <returns></returns>
        Task<(string member, decimal score)[]> ZPopMinAsync(string key, long count);
        ...
        /// <param name="count">数量</param>
        /// <returns></returns>
        Task<(T member, decimal score)[]> ZPopMinAsync<T>(string key, long count);
        #endregion
        ...
        Task<bool> GeoAddAsync(string key, decimal longitude, decimal latitude, object member);
        ...
        /// <returns></returns>
        Task<string[]> GeoRadiusAsync(string key, decimal longitude, decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null);
        ...
        /// <param name="sorting">排序</param>
        /// <returns></returns>
        Task<T[]> GeoRadiusAsync<T>(string key, decimal longitude, decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null);
        ...
        /// <param name="sorting">排序</param>
        /// <returns></returns>
        Task<(string member, decimal dist)[]> GeoRadiusWithDistAsync(string key, decimal longitude, decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null);
        ...
        /// <param name="sorting">排序</param>
        /// <returns></returns>
        Task<(T member, decimal dist)[]> GeoRadiusWithDistAsync<T>(string key, decimal longitude, decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null);
        ...
        /// <param name="sorting">排序</param>
        /// <returns></returns>
        Task<(string member, decimal dist, decimal longitude, decimal latitude)[]> GeoRadiusWithDistAndCoordAsync(string key, decimal longitude, decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null);
        ...
        /// <param name="sorting">排序</param>
        /// <returns></returns>
        Task<(T member, decimal dist, decimal longitude, decimal latitude)[]> GeoRadiusWithDistAndCoordAsync<T>(string key, decimal longitude, decimal latitude, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null);
        ...
        /// <param name="sorting">排序</param>
        /// <returns></returns>
        Task<string[]> GeoRadiusByMemberAsync(string key, object member, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null);
        ...
        /// <param name="sorting">排序</param>
        /// <returns></returns>
        Task<T[]> GeoRadiusByMemberAsync<T>(string key, object member, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null);
        ...
        /// <param name="sorting">排序</param>
        /// <returns></returns>
        Task<(string member, decimal dist)[]> GeoRadiusByMemberWithDistAsync(string key, object member, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null);
        ...
        /// <param name="sorting">排序</param>
        /// <returns></returns>
        Task<(T member, decimal dist)[]> GeoRadiusByMemberWithDistAsync<T>(string key, object member, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null);
        ...
        /// <param name="sorting">排序</param>
        /// <returns></returns>
        Task<(string member, decimal dist, decimal longitude, decimal latitude)[]> GeoRadiusByMemberWithDistAndCoordAsync(string key, object member, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null);
        ...
        /// <param name="sorting">排序</param>
        /// <returns></returns>
        Task<(T member, decimal dist, decimal longitude, decimal latitude)[]> GeoRadiusByMemberWithDistAndCoordAsync<T>(string key, object member, decimal radius, GeoUnit unit = GeoUnit.m, long? count = null, GeoOrderBy? sorting = null);
        #endregion
        #endregion
        ...
        /// 在所有分区节点上，执行服务器命令
        /// </summary>
        CSRedisClient.NodesServerManagerProvider NodesServerManager();
